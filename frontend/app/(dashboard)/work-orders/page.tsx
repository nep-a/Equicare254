            ...
            {loading ? (
              ...
              <tr key={wo.id}>
                <td className={styles.woId}>
                  <Link href={`/dashboard/work-orders/${wo.id}`}>{wo.wo_number}</Link>
                </td>
                <td>
                  <div className={styles.eqId}>{wo.assets?.asset_number || 'Unknown'}</div>
                  <div className={styles.eqType}>{wo.assets?.equipment_models?.model_name || 'General'}</div>
                </td>
                <td>
                  <div className={styles.woType}>{wo.type}</div>
                ...
                <td className={styles.faultCol}>
                  <span className={styles.faultText}>{wo.reported_fault}</span>
                </td>
                <td>{wo.users ? `${wo.users.first_name} ${wo.users.last_name}` : 'Unassigned'}</td>
                <td>-</td>
              </tr>
            ))}
          </tbody>
